          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="image_field ml-auto mr-auto mb-3">
                <img v-if="wetland.pic_url && !uploadedImageUrl" :src="baseUrl + wetland.pic_url" alt="" />
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-success">Update Wetland</button>
              </div>
            </div>
...
export default {
  ...
  methods: {
    updateWetland() {
      ...
      axios.post('/api/wetland/' + this.$route.params.id + '/edit', data)
      .then(response => {
        this.wetland = response.data.updatedWetland
        this.loading = false;

        let desc = "# Updated wetland \r\n";
        desc += "* Affected wetland - \r\n &nbsp; &nbsp; &nbsp;> " 
                    + this.wetland.name
                    + ", " + this.wetland.location;
