...
export default {
  ...
  computed: {
    ...
    currentUser() {
      return this.$store.getters['guestM/getCurrentUser'];
    },
    filteredWetlands() {
  ...
  methods: {
    logOut() {
      this.$store.dispatch('guestM/logOut', this.$router);
    },
    ...
    setSearchQuery() {
      this.filterNature = this.$route.query.nature;
      this.filterName = this.$route.query.name;
      this.filterLocation = this.$route.query.location;
      this.filterArea = this.$route.query.area;
      this.filterFlora = this.$route.query.flora;
      this.filterFauna = this.$route.query.fauna;
    },
    triggerWatch() {
      this.itemsStartFrom = 0;
      this.currentPageNumber = 1;
      this.triggerPagination(this.currentPageNumber);
    }
  },
  watch: {
    filterNature() {
